...
global.owner = process.env.OWNER_NUMBER  || '263717087726' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || '1VAJIRA-MD=uQ8GjTAb#UAKvsVLu4DfV8WjxYhayyPsTdsdolbqT7fqFXMbZU-0' ,
